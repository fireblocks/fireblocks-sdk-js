...
import {
  ...
  InternalWalletAsset,
  InternalTransferExchangeAssetResponse,
...
export class FireblocksSDK {
  ...
  constructor(
    ...
    this.authProvider =
      authProvider ?? new ApiTokenProvider(privateKey, apiKey);
  ...
  public async getVaultAccountsWithPageInfo(
    ...
    return await this.apiClient.issueGetRequest(
      `/v1/vault/accounts_paged?${queryString.stringify(
        pagedVaultAccountsRequestFilters
      )}`
    );
  }
   ...
   * @param vaultAccountId The vault account ID
   */
  public async getVaultAccountById(
    vaultAccountId: string
  ): Promise<VaultAccountResponse> {
    return await this.apiClient.issueGetRequest(
   ...
   */
  public async getVaultAccountAsset(
    vaultAccountId: string,
    assetId: string
   ...
   */
  public async refreshVaultAssetBalance(
    vaultAccountId: string,
    assetId: string,
   ...
   */
  public async setAddressDescription(
    vaultAccountId: string,
    assetId: string,
    address: string,
    tag?: string,
   ...
   */
  public async getNetworkConnectionById(
    connectionId: string
   ...
   */
  public async getExchangeAccount(
   ...
   * @param exchangeAccountId The exchange account ID
   */
  public async getExchangeAccountById(
    exchangeAccountId: string
  ): Promise<ExchangeResponse> {
    return await this.apiClient.issueGetRequest(
  ...
  /**
   * Internal transfer Exchange Asset
   * @param exchangeAccountId The exchange account ID
   ...
   */
  public async internalTransferExchangeAsset(
    exchangeAccountId: string,
    ...
    amount: string,
    requestOptions?: RequestOptions
  ): Promise<InternalTransferExchangeAssetResponse> {
    return await this.apiClient.issuePostRequest(
   ...
   */
  public async convertExchangeAsset(
    exchangeAccountId: string,
    srcAsset: string,
    destAsset: string,
    amount: number,
    requestOptions?: RequestOptions
  ): Promise<ConvertExchangeAssetResponse> {
    return await this.apiClient.issuePostRequest(
  ...
  public async transferToSubaccount(
    ...
    return await this.apiClient.issuePostRequest(
      `/v1/exchange_accounts/${exchangeAccountId}/${assetId}/transfer_to_subaccount`,
      body,
      requestOptions
    );
  }
   ...
   * @param requestOptions
   */
  public async transferFromSubaccount(
    exchangeAccountId: string,
    subaccountId: string,
    assetId: string,
    amount: number,
    ...
    return await this.apiClient.issuePostRequest(
      `/v1/exchange_accounts/${exchangeAccountId}/${assetId}/transfer_from_subaccount`,
      body,
      requestOptions
    );
  }
   ...
   */
  public async getFiatAccountById(
    accountId: string
  ): Promise<FiatAccountResponse> {
    return await this.apiClient.issueGetRequest(
   ...
   * @param requestOptions
   */
  public async redeemToLinkedDDA(
    accountId: string,
    amount: number,
    requestOptions?: RequestOptions
  ): Promise<OperationSuccessResponse> {
  ...
  public async getTransactions(
    ...
    return await this.apiClient.issueGetRequest(
      `/v1/transactions?${queryString.stringify(filter)}`
    );
  }
   ...
   */
  public async getTransactionsWithPageInfo(
    pageFilter?: TransactionPageFilter,
    nextOrPreviousPath?: string
  ): Promise<TransactionPageResponse> {
    if (pageFilter) {
      return await this.apiClient.issueGetRequest(
        `/v1/transactions?${queryString.stringify(pageFilter)}`,
        true
      );
    } else if (nextOrPreviousPath) {
      const index = nextOrPreviousPath.indexOf("/v1/");
      const path = nextOrPreviousPath.substring(
        index,
        nextOrPreviousPath.length
      );
   ...
   * @param externalTxId
   */
  public async getTransactionByExternalTxId(
    externalTxId: string
  ): Promise<TransactionResponse> {
    return await this.apiClient.issueGetRequest(
   ...
   */
  public async getInternalWallets(): Promise<
    WalletContainerResponse<InternalWalletAsset>[]
  > {
   ...
   */
  public async getInternalWallet(
    walletId: string
  ): Promise<WalletContainerResponse<InternalWalletAsset>> {
    return await this.apiClient.issueGetRequest(
   ...
   */
  public async getInternalWalletAsset(
    walletId: string,
    assetId: string
  ): Promise<InternalWalletAsset> {
    return await this.apiClient.issueGetRequest(
   ...
   */
  public async getExternalWallets(): Promise<
   ...
   */
  public async getExternalWallet(
    walletId: string
  ): Promise<WalletContainerResponse<ExternalWalletAsset>> {
    return await this.apiClient.issueGetRequest(
   ...
   * @param assetId The asset ID
   */
  public async getExternalWalletAsset(
    walletId: string,
    assetId: string
  ): Promise<ExternalWalletAsset> {
    return await this.apiClient.issueGetRequest(
   ...
   */
  public async getContractWallets(): Promise<
    WalletContainerResponse<ExternalWalletAsset>[]
  > {
   ...
   */
  public async getContractWallet(
    walletId: string
  ): Promise<WalletContainerResponse<ExternalWalletAsset>> {
   ...
   * @param assetId The asset ID
   */
  public async getContractWalletAsset(
    walletId: string,
    assetId: string
  ): Promise<ExternalWalletAsset> {
    return await this.apiClient.issueGetRequest(
      `/v1/contracts/${walletId}/${assetId}`
    );
  }
   ...
   */
  public async updateVaultAccount(
    vaultAccountId: string,
    name: string
  ): Promise<VaultAccountResponse> {
    const body = {
   ...
   * @param requestOptions
   */
  public async activateVaultAsset(
    vaultAccountId: string,
    assetId: string,
    requestOptions?: RequestOptions
  ): Promise<VaultAssetResponse> {
   ...
   */
  public async createContractWallet(
    name: string,
    requestOptions?: RequestOptions
  ): Promise<WalletContainerResponse<ExternalWalletAsset>> {
    const body = {
   ...
   * @param requestOptions
   */
  public async createInternalWalletAsset(
    walletId: string,
    assetId: string,
    address: string,
    tag?: string,
   ...
   * @param tag (for ripple only) The ripple account tag
   */
  public async createContractWalletAsset(
    walletId: string,
    assetId: string,
    address: string,
    tag?: string,
   ...
   */
  public async estimateFeeForTransaction(
    transactionArguments: TransactionArguments,
    requestOptions?: RequestOptions
  ...
  public async getFeeForAsset(asset: string): Promise<EstimateFeeResponse> {
    return await this.apiClient.issueGetRequest(
      `/v1/estimate_network_fee?assetId=${asset}`
    );
  }
  ...
  public async createTransferTicket(
    options: CreateTransferTicketArgs,
    requestOptions?: RequestOptions
   ...
   * @param ticketId
   */
  public async getTransferTicketById(
    ticketId: string
  ): Promise<TransferTicketResponse> {
    return await this.apiClient.issueGetRequest(
      `/v1/transfer_tickets/${ticketId}`
    );
  }
   ...
   * @param termId
   */
  public async getTransferTicketTerm(
    ticketId: string,
    termId: string
  ): Promise<TermResponse> {
    return await this.apiClient.issueGetRequest(
      `/v1/transfer_tickets/${ticketId}/${termId}`
    );
  }
   ...
   * @param requestOptions
   */
  public async cancelTransferTicket(
    ticketId: string,
    requestOptions?: RequestOptions
  ) {
    return await this.apiClient.issuePostRequest(
      `/v1/transfer_tickets/${ticketId}/cancel`,
      {},
      requestOptions
    );
  }
   ...
   * @param requestOptions
   */
  public async executeTransferTicketTerm(
    ticketId: string,
    termId: string,
    options: ExecuteTermArgs,
    requestOptions?: RequestOptions
  ) {
    return await this.apiClient.issuePostRequest(
      `/v1/transfer_tickets/${ticketId}/${termId}/transfer`,
      options,
      requestOptions
    );
  }
   ...
   * @param walletId The internal wallet ID
   */
  public async deleteInternalWallet(
    walletId: string
  ): Promise<OperationSuccessResponse> {
    return await this.apiClient.issueDeleteRequest(
      `/v1/internal_wallets/${walletId}`
    );
  }
   ...
   * @param assetId The asset ID
   */
  public async deleteInternalWalletAsset(
    walletId: string,
    assetId: string
  ): Promise<OperationSuccessResponse> {
    return await this.apiClient.issueDeleteRequest(
   ...
   * @param walletId The external wallet ID
   */
  public async deleteExternalWallet(
    walletId: string
  ): Promise<OperationSuccessResponse> {
    return await this.apiClient.issueDeleteRequest(
      `/v1/external_wallets/${walletId}`
   ...
   * @param assetId The asset ID
   */
  public async deleteExternalWalletAsset(
    walletId: string,
    assetId: string
  ): Promise<OperationSuccessResponse> {
    return await this.apiClient.issueDeleteRequest(
   ...
   * @param walletId The contract wallet ID
   */
  public async deleteContractWallet(
    walletId: string
  ): Promise<OperationSuccessResponse> {
   ...
   * @param assetId The asset ID
   */
  public async deleteContractWalletAsset(
    walletId: string,
    assetId: string
  ): Promise<OperationSuccessResponse> {
    return await this.apiClient.issueDeleteRequest(
   ...
   * @param requestOptions
   */
  public async setCustomerRefIdForVaultAccount(
    vaultAccountId: string,
    customerRefId: string,
    requestOptions?: RequestOptions
  ): Promise<OperationSuccessResponse> {
   ...
   * @param requestOptions
   */
  public async setCustomerRefIdForExternalWallet(
    walletId: string,
    customerRefId: string,
    requestOptions?: RequestOptions
  ): Promise<OperationSuccessResponse> {
   ...
   * @param requestOptions
   */
  public async setCustomerRefIdForAddress(
    vaultAccountId: string,
    assetId: string,
    address: string,
    tag?: string,
   ...
   * @param requestOptions
   */
  public async setConfirmationThresholdForTxId(
    txId: string,
    requiredConfirmationsNumber: number,
    requestOptions?: RequestOptions
  ): Promise<OperationSuccessResponse> {
    return await this.apiClient.issuePostRequest(
      `/v1/transactions/${txId}/set_confirmation_threshold`,
      { numOfConfirmations: requiredConfirmationsNumber },
      requestOptions
    );
  }
   ...
   * @param requestOptions
   */
  public async setConfirmationThresholdForTxHash(
    txHash: string,
    requiredConfirmationsNumber: number,
    requestOptions?: RequestOptions
  ): Promise<OperationSuccessResponse> {
   ...
   * @param requestOptions
   */
  public async allocateFundsToPrivateLedger(
    vaultAccountId: string,
    asset: string,
    args: AllocateFundsRequest,
    requestOptions?: RequestOptions
  ) {
   ...
   * @param args
   */
  public async getPublicKeyInfoForVaultAccount(
   ...
   */
  public async getMaxSpendableAmount(
    vaultAccountId: string,
    assetId: string,
   ...
   * @param requestOptions
   */
  public async unfreezeTransactionById(
    txId: string,
    requestOptions?: RequestOptions
  ): Promise<OperationSuccessResponse> {
   ...
   * @param requestOptions
   */
  public async freezeTransactionById(
    txId: string,
    requestOptions?: RequestOptions
  ): Promise<OperationSuccessResponse> {
    return this.apiClient.issuePostRequest(
  ...
  public async resendWebhooks(
    requestOptions?: RequestOptions
  ): Promise<ResendWebhooksResponse> {
    return await this.apiClient.issuePostRequest(
      "/v1/webhooks/resend",
      {},
      requestOptions
   ...
   * @param requestOptions
   */
  public async resendTransactionWebhooksById(
    txId: string,
   ...
   */
  public async getOffExchangeAccountById(
    id: string
  ): Promise<OffExchangeEntityResponse> {
    return await this.apiClient.issueGetRequest(
      `/v1/off_exchange_accounts/${id}`
    );
  }
   ...
   * @param requestOptions
   */
  public async settleOffExchangeAccountById(
    id: string,
    requestOptions?: RequestOptions
  ): Promise<void> {
    return await this.apiClient.issuePostRequest(
      `/v1/off_exchange_accounts/${id}/settle`,
      {},
      requestOptions
    );
  }
   ...
   * @param requestOptions
   */
  public async setFeePayerConfiguration(
    baseAsset: string,
    feePayerConfiguration: SetFeePayerConfiguration,
    requestOptions?: RequestOptions
  ): Promise<FeePayerConfiguration> {
    return await this.apiClient.issuePostRequest(
      `/v1/fee_payer/${baseAsset}`,
      feePayerConfiguration,
      requestOptions
    );
  }
   ...
   * @param baseAsset
   */
  public async getFeePayerConfiguration(
    baseAsset: string
  ): Promise<FeePayerConfiguration> {
